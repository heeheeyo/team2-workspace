...
-- NOTICE ��������
-- SYSDATE DEFAULT SYSDATE �߰�
CREATE TABLE TB_NOTICE (
    NOTICE_NO NUMBER PRIMARY KEY,
    NOTICE_TITLE VARCHAR2(100) NOT NULL,
    NOTICE_CONTENT VARCHAR2(4000) NOT NULL,
    NOTICE_DATE DATE DEFAULT SYSDATE NOT NULL, -- DEFAULT �߰�
...
CREATE TABLE TB_HEADER (
	...
	HEADER_CONTENT	VARCHAR2(20) NOT NULL -- ��Ÿ���� (HERADER -> HEADER)
);
...
CREATE TABLE TB_ORDER (
	...
	ORDER_STATUS VARCHAR2(20) DEFAULT '��ǰ�غ���' CHECK(ORDER_STATUS IN('��ǰ�غ���','�����','��ۿϷ�','��ҿϷ�','��ȯ��û','��ȯ��','��ȯ�Ϸ�','ȯ�ҿ�û','ȯ����','ȯ�ҿϷ�')) NOT NULL,
	...
	RCP_MSG	VARCHAR2(50),
    SAVE_MILEAGE NUMBER NOT NULL, -- �߰��÷�
    USE_MILEAGE NUMBER -- �߰��÷�
);
...
CREATE TABLE TB_MILEAGE_HISTORY(
    ...
    MILEAGE NUMBER, -- �߰��÷�
    ORDER_NO NUMBER NOT NULL REFERENCES TB_ORDER -- �߰� �÷�
);

CREATE TABLE TB_DTL_ORDER( --�߰� ���̺�
...
COMMENT ON COLUMN TB_HEADER.HERADER_CONTENT IS '말머리내용';
...
COMMENT ON COLUMN TB_INSTAGRAM.COM_NO IS '�Խñ۹�ȣ';
COMMENT ON COLUMN TB_INSTAGRAM.COM_CONTENT IS '�Խñ۳���';
COMMENT ON COLUMN TB_INSTAGRAM.COM_TAG IS '�±�';
COMMENT ON COLUMN TB_INSTAGRAM.INSTA_ID IS '�ν�Ÿ���̵�';
COMMENT ON COLUMN TB_INSTAGRAM.DEL_YN IS '��������';
COMMENT ON COLUMN TB_INSTAGRAM.MEM_NO IS 'ȸ����ȣ';
COMMENT ON COLUMN TB_INSTAGRAM.IMG_NO IS '�̹�����ȣ';

COMMENT ON COLUMN TB_INSTA_IMAGE.INSTA_IMG_NO IS '�̹�����ȣ';
COMMENT ON COLUMN TB_INSTA_IMAGE.INSTA_IMG_ORIGIN IS '�����̹����̸�';
COMMENT ON COLUMN TB_INSTA_IMAGE.INSTA_IMG_SRC IS '�̹������';
COMMENT ON COLUMN TB_INSTA_IMAGE.INSTA_IMG_CHANGE IS '�ٲ��̹����̸�';

COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.ANS_NO IS '��۹�ȣ';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.ANS_CONTENT IS '��۳���';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.ANS_DATE IS '�ۼ���¥';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.ADD_ANS_YN IS '���ۿ���';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.OG_ANS_NO IS '����ۿ���';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.DEL_YN IS '��������';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.COM_NO IS '�Խñۿ���';
COMMENT ON COLUMN TB_ANSWER_INSTAGRAM.MEM_NO IS 'ȸ����ȣ';

COMMENT ON COLUMN TB_LIKE.LIKE_NO IS '���ƿ��ȣ';
COMMENT ON COLUMN TB_LIKE.MEM_NO IS 'ȸ����ȣ';
COMMENT ON COLUMN TB_LIKE.COM_NO IS '�Խñ۹�ȣ';

COMMENT ON COLUMN TB_CATEGORY.CATEGORY_NO IS 'ī�װ�����ȣ';
COMMENT ON COLUMN TB_CATEGORY.CATEGORY_NAME IS 'ī�װ����̸�';

COMMENT ON COLUMN TB_MANAGER.MANAGER_NO IS '�����ڹ�ȣ';
COMMENT ON COLUMN TB_MANAGER.MANAGER_ID IS '�����ھ��̵�';
COMMENT ON COLUMN TB_MANAGER.MANAGER_PWD IS '�����ں�й�ȣ';
COMMENT ON COLUMN TB_MANAGER.MANAGER_NAME IS '�������̸�'; -- �߰� �ڸ�Ʈ

COMMENT ON COLUMN TB_BRAND.BRAND_NO IS '�귣���ȣ';
COMMENT ON COLUMN TB_BRAND.BRAND_NAME IS '�귣���̸�';

COMMENT ON COLUMN TB_OPTION.OPTION_NO IS '�ɼǹ�ȣ';
COMMENT ON COLUMN TB_OPTION.OPTION_SIZE IS '��ǰ������';
COMMENT ON COLUMN TB_OPTION.OPTION_STOCK IS '�ɼ����';
COMMENT ON COLUMN TB_OPTION.PRODUCT_NO IS '��ǰ��ȣ';

COMMENT ON COLUMN TB_LOCATION.LOC_NO IS '�������ȣ';
COMMENT ON COLUMN TB_LOCATION.LOC_ADDRESS_NAME IS '�������';
COMMENT ON COLUMN TB_LOCATION.LOC_NAME IS '�����θ�';
COMMENT ON COLUMN TB_LOCATION.LOC_PHONE IS '��ȭ��ȣ';
COMMENT ON COLUMN TB_LOCATION.LOC_ADDRESS IS '�ּ�';
COMMENT ON COLUMN TB_LOCATION.LOC_ADDRESS_DTL IS '���ּ�';
COMMENT ON COLUMN TB_LOCATION.LOC_POST_CODE IS '������ȣ';
COMMENT ON COLUMN TB_LOCATION.LOC_YN IS '�⺻���������';
COMMENT ON COLUMN TB_LOCATION.DEL_YN IS '��������';
COMMENT ON COLUMN TB_LOCATION.MEM_NO IS 'ȸ����ȣ';

COMMENT ON COLUMN TB_MILEAGE_HISTORY.MILEAGE_NO IS '�����ݹ�ȣ';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.MILEAGE_HISTORY IS '�����ݳ���';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.MILEAGE IS '������';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.ORDER_NO IS '�ֹ���ȣ';
...
<<<<<<< HEAD
COMMENT ON COLUMN TB_PRODUCT_IMAGE.PRODUCT_IMG_NO IS '�̹�����ȣ';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.PRODUCT_NO IS '������ǰ��ȣ';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.CHANGE_NAME IS '���Ͽ�����';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.ORIGIN_NAME IS '���ϼ�����';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.FILE_PATH IS '�����������';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.UPLOAD_DATE IS '���ε���';
COMMENT ON COLUMN TB_PRODUCT_IMAGE.DEL_YN IS '��������(Y/N)';
=======
COMMENT ON COLUMN TB_ORDER.ORDER_NO IS '�ֹ�����';
COMMENT ON COLUMN TB_ORDER.MEM_NO IS 'ȸ����ȣ';
COMMENT ON COLUMN TB_ORDER.ORDER_QNT IS '�ֹ�����';
COMMENT ON COLUMN TB_ORDER.ORDER_DATE IS '�ֹ���¥';
COMMENT ON COLUMN TB_ORDER.ORDER_STATUS IS '�ֹ�����';
COMMENT ON COLUMN TB_ORDER.RCP_ADDRESS_NAME IS '�������';
COMMENT ON COLUMN TB_ORDER.RCP_NAME IS '�����θ�';
COMMENT ON COLUMN TB_ORDER.RCP_PHONE IS '������ ��ȭ��ȣ';
COMMENT ON COLUMN TB_ORDER.RCP_ADDRESS IS '�ּ�';
COMMENT ON COLUMN TB_ORDER.RCP_ADDRESS_DTL IS '���ּ�';
COMMENT ON COLUMN TB_ORDER.RCP_MSG IS '��û����';
COMMENT ON COLUMN TB_ORDER.SAVE_MILEAGE IS '�������ϸ���'; -- �߰��ڸ�Ʈ
COMMENT ON COLUMN TB_ORDER.USE_MILEAGE IS '��븶�ϸ���'; -- �߰��ڸ�Ʈ
>>>>>>> parent of 568564b (sql문 수정)

COMMENT ON COLUMN TB_DTL_ORDER.DTL_ORDER_NO IS '�ֹ� �󼼹�ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.PRODUCT_NO IS '��ǰ��ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.ORDER_NO IS '�ֹ���ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_SIZE IS '��ǰ ������';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_QNT IS '��ǰ ����';
...
COMMENT ON COLUMN TB_MILEAGE_HISTORY.PRODUCT_NO IS '상품번호';
...
COMMENT ON COLUMN TB_MILEAGE_HISTORY.MILEAGE_HISTORY IS '�����ݳ���';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.MILEAGE IS '������';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.MEM_NO IS 'ȸ����ȣ';
COMMENT ON COLUMN TB_MILEAGE_HISTORY.ORDER_NO IS '�ֹ���ȣ'; --�߰��ڸ�Ʈ

COMMENT ON COLUMN TB_RETURN.RETURN_NO IS 'ȯ�ҹ�ȣ';
COMMENT ON COLUMN TB_RETURN.RETURN_STATUS IS 'ȯ�һ���';
COMMENT ON COLUMN TB_RETURN.RETURN_REASON IS 'ȯ�һ���';
COMMENT ON COLUMN TB_RETURN.ORDER_NO IS '�ֹ�����';
...
COMMENT ON COLUMN TB_ORDER.RCP_ADDRESS_DTL IS '���ּ�';
COMMENT ON COLUMN TB_ORDER.RCP_MSG IS '��û����';
COMMENT ON COLUMN TB_ORDER.SAVE_MILEAGE IS '�������ϸ���';
COMMENT ON COLUMN TB_ORDER.USE_MILEAGE IS '��븶�ϸ���';

COMMENT ON COLUMN TB_DTL_ORDER.DTL_ORDER_NO IS '���ֹ���ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.PRODUCT_NO IS '��ǰ��ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.ORDER_NO IS '�ֹ���ȣ';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_SIZE IS '�ֹ� ��ǰ ������';
COMMENT ON COLUMN TB_DTL_ORDER.DTL_QNT IS '�ֹ� ��ǰ ����';
=======
COMMENT ON COLUMN TB_ORDER.ORDER_NO IS '주문정보';
COMMENT ON COLUMN TB_ORDER.MEM_NO IS '회원번호';
COMMENT ON COLUMN TB_ORDER.PRODUCT_NO IS '상품번호';
...
INSERT INTO TB_MEMBER VALUES(SEQ_MEMBER.NEXTVAL,'user01','pass01','박희연','email01@kh.kr','01062612122',DEFAULT,DEFAULT,NULL,NULL,NULL,DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES(SEQ_MEMBER.NEXTVAL,'user02','pass02','이윤화','email02@kh.kr','01064622323',DEFAULT,DEFAULT,NULL,NULL,NULL,DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES(SEQ_MEMBER.NEXTVAL,'user03','pass03','전혜정','email03@kh.kr','01066632524',DEFAULT,DEFAULT,NULL,NULL,NULL,DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES(SEQ_MEMBER.NEXTVAL,'user04','pass04','정지용','email04@kh.kr','01068642725',DEFAULT,DEFAULT,NULL,NULL,NULL,DEFAULT,DEFAULT);
INSERT INTO TB_MEMBER VALUES(SEQ_MEMBER.NEXTVAL,'user05','pass05','최승협','email05@kh.kr','01060652926',DEFAULT,DEFAULT,NULL,NULL,NULL,DEFAULT,DEFAULT);
...
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진1','/resources/img/insta-image1.jpg','바뀐사진1');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진2','/resources/img/insta-image2.jpg','바뀐사진2');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진3','/resources/img/insta-image3.jpg','바뀐사진3');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진4','/resources/img/insta-image4.jpg','바뀐사진4');
INSERT INTO TB_INSTA_IMAGE VALUES(SEQ_INSTA_IMAGE.NEXTVAL,'익명의 패션사진5','/resources/img/insta-image5.jpg','바뀐사진5');
...
VALUES(SEQ_INQUIRE.NEXTVAL, '�����Ϳ�', '�ֹ����� ���ð� �����µ� �����Ϳ�', SYSDATE, 0, '15�� ���� �ֹ� ���� ���� 17�ÿ� ����˴ϴ�.', SYSDATE, DEFAULT,DEFAULT, 2, 2, 1);
INSERT INTO TB_INQUIRE
VALUES(SEQ_INQUIRE.NEXTVAL, '��ǰ���� ���� �帳�ϴ�.', '�ش� ��ǰ ���԰� ���� �ǳ���', SYSDATE, 0, '�ش� ��ǰ�� ���� ���԰� ��ȹ�� �����ϴ�.', SYSDATE, 'Y',DEFAULT, 1, 3, 2);
INSERT INTO TB_INQUIRE
VALUES(SEQ_INQUIRE.NEXTVAL, '��ȯ���ּ���!', '�� ������ ū ġ���� ��Ź�����', '2022-12-21', 0, '�������� �ٽ� �����ֽø� ��ȯ�� �帮�ڽ��ϴ�.', '2022-12-21', DEFAULT,DEFAULT, 3, 2, 3);
INSERT INTO TB_INQUIRE
VALUES(SEQ_INQUIRE.NEXTVAL, '�������� ���� ��ġ', '��ġ�� ����', '2022-11-17', 0, '������ ���ﵿ ���ּ���ũ 77�� 8ȣ�Դϴ�.', '2022-11-17', 'Y',DEFAULT, 4, 3, 4);
INSERT INTO TB_INQUIRE
VALUES(SEQ_INQUIRE.NEXTVAL, '�ֹ� ��� ��û�մϴ�', '��� ���� �ߴµ� ��� ��Ź�����', '2022-09-01', 0, '�ش� ��ǰ ��� ������ �ֹ� ��� �Ǿ����ϴ�, �����մϴ�.', '2022-09-01', DEFAULT,DEFAULT, 2, 1, 5);
...
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,1,DEFAULT,'��ۿϷ�',NULL,'����','01062612122','���� ���̾� ����Ʈ','101��303ȣ','06218',NULL,300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,2,1,DEFAULT,'��ۿϷ�',NULL,'����ȭ','01064622323','���� ���̾� ����Ʈ','103��503ȣ','06218','����� ���տ� �ΰ����ּ���',300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,3,2,DEFAULT,'��ۿϷ�',NULL,'������','01066632524','���ǵ� ���̾���Ʈ','105�� 809ȣ','07324','���ǿ� �ð��ּ���',300,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,4,1,DEFAULT,'��ۿϷ�',NULL,'������','01068642725','�ű� ��þ���Ʈ','101�� 303ȣ','07362',NULL,500,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,5,1,DEFAULT,'��ۿϷ�',NULL,'�ֽ���','01060652926','���ǵ� ���̾���Ʈ','106�� 1103ȣ','07324',NULL,500,0);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,1,2,1,DEFAULT,' 배송완료',NULL,'박희연','01062612122','역삼 래미안 아파트','101동303호','06218',NULL);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,2,1,1,DEFAULT,' 배송완료',NULL,'이윤화','01064622323','역삼 래미안 아파트','103동503호','06218','부재시 문앞에 두고가주세요');
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,3,1,2,DEFAULT,' 배송완료',NULL,'전혜정','01066632524','여의도 자이아파트','105동 809호','07324','경비실에 맡겨주세요');
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,4,3,1,DEFAULT,' 배송완료',NULL,'정지용','01068642725','신길 목련아파트','101동 303호','07362',NULL);
INSERT INTO TB_ORDER VALUES(SEQ_ORDER.NEXTVAL,5,4,1,DEFAULT,' 배송완료',NULL,'최승협','01060652926','여의도 자이아파트','106동 1103호','07324',NULL);
...
INSERT INTO TB_CART VALUES(SEQ_CART.NEXTVAL,6,2,1,'S',DEFAULT);
...
<<<<<<< HEAD
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�������� ���� ����','https://image.brandi.me/cproduct/2023/02/10/SB000000000001176832_1676013624_image5_S.jpeg',1,1);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�������� ���� ����','https://image.brandi.me/cproduct/2023/02/10/SB000000000001176832_1676013624_image3_S.jpeg',1,2);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�������� ���� ����','https://image.brandi.me/cproduct/2023/02/10/SB000000000001176832_1676013624_image2_S.jpeg',1,2);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�������� ���� ����','<img src="https://image.brandi.me/media/488cc22e6cdca788f59c27a531a22167.jpg">',1,3);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�����ø��� ���λ���','https://image.brandi.me/cproduct/2023/01/26/SB000000000000032889_1674717666_image1_S.jpeg',2,1);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'��ȫ �е� ���λ���','https://image.brandi.me/cproduct/2023/02/13/SB000000000001336262_1676278968_image1_S.jpeg',3,1);
--INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'�߱���Ĺ ���λ���','https://image.brandi.me/cproduct/2023/01/31/SB000000000000918406_1675149911_image1_S.jpeg',4,1);
...
INSERT INTO TB_PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMAGE.NEXTVAL,'멋진 티셔츠 사진','/resources/img5.jpg',5,1);
>>>>>>> parent of 568564b (sql문 수정)
...
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'���',NULL,1);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'���',NULL,2);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'����',NULL,3);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'����',NULL,4);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'����',NULL,5);
...
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'사용',200,2,1);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',300,2,2);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',100,3,3);
INSERT INTO TB_MILEAGE_HISTORY VALUES(SEQ_MILEAGE_HISTORY.NEXTVAL,'적립',150,4,4);
